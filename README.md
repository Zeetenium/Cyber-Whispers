...
本项目是我作为一名即将大二的前端小白，在未接触过 Uniapp 也未完成过全栈项目的情况下，耗时 18 天独立完成的（想了解背后故事？[戳这篇博客链接](#)），其中必然有很多考虑不周、可以优化之处。正如我在视频里分享的，这段经历充满的不仅仅是各种挑战，还有无奈的妥协，但也正因如此，它才是一个无比真实的学习案例。
